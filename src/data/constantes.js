...
export const SOBREMI = `Soy un desarrollador full stack apasionado por crear aplicaciones web eficientes. Manejo tecnologías como React, Next.js, Node.js y bases de datos como MySQL, PostgreSQL y MongoDB. Me encanta resolver problemas complejos y aprender constantemente. Fuera de la programación, disfruto explorar nuevas tecnologías y colaborar en proyectos de código abierto.`;
...
export const PROYECTOS = [
  ...
  },
  {
    ...
    imagen: fondogastos,  // Aquí pones la imagen de tu proyecto
    descripcion:
    ...
    url: "https://app-gastos-mern.vercel.app/",  // Añadir URL del proyecto
  },
  {
    titulo: "Chat MERN - Real-Time Messaging",
    imagen: chatfondo,  // Aquí pondrás la imagen de tu proyecto
    descripcion:
    ...
    url: "https://chat-mern-nicolas-laimes-projects.vercel.app/",  // Añadir URL de tu proyecto
  }
];
